...
export default function About() {
    ...
    const [theme,setMyTheme]=useState("Enable");
  ...
  <div className="accordion-item">
    <h2 className="accordion-header" id="headingOne">
      <button className="accordion-button my-" style={myStyle} type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
        Accordion Item #1
      </button>
    </h2>
  ...
  <div className="accordion-item">
    ...
    <button className="btn btn-primary my-3" onClick={toggleStyle}>{theme} dark mode</button>
    </div>
  )
}
